...
insert into purchase_order (created_at, store_id)
values ('2022-08-13 07:07:00+07:00', (select id from store where name = 'Store number 2'));
...
insert into purchase_order_position (order_id, rssfeed_id)
values (
(select id from purchase_order where created_at = '2022-08-13 07:07:00+07:00'),
(select id from rssfeed where name = 'RSS from file 2')
);
insert into purchase_order_position (order_id, rssfeed_id)
values (
